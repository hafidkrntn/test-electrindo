const Sidebar = () => {
  return (
    <aside className="w-64" aria-label="Sidebar">
      <div className="px-3 max-h-full h-screen py-4 overflow-y-auto rounded bg-[#343D4D]">
